...
for unit in range(len(spikes)):
        ...
        try:
            ...
            if np.isnan(one_autocorrelation).any() == True:
                ...
                all_data_steinmetz_dg.append(('steinmetz','mouse','dg',unit,pars[1],np.sum(summed_spikes_per_bin)/trials,r2,pars[0],pars[2]))
...
with open('/Users/zachz/Documents/timescales_analysis/results.csv','a') as out:
    ...
    for row in all_data_steinmetz_dg:
...
a_population_steinmetz_dg = (('steinmetz','dg',steinmetz_dg_pars[1],steinmetz_dg_mean_fr,len(steinmetz_dg_taus)))
