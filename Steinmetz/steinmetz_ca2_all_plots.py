...
for unit in range(len(spikes)):
        ...
        try:
            ...
            if np.isnan(one_autocorrelation).any() == True:
                ...
                all_data_steinmetz_ca2.append(('steinmetz','mouse','ca2',unit,pars[1],np.sum(summed_spikes_per_bin)/trials,r2,pars[0],pars[2]))
...
with open('/Users/zachz/Documents/timescales_analysis/results.csv','a') as out:
    ...
    for row in all_data_steinmetz_ca2:
...
a_population_steinmetz_ca2 = (('steinmetz','ca2',steinmetz_ca2_pars[1],steinmetz_ca2_mean_fr,len(steinmetz_ca2_taus)))
