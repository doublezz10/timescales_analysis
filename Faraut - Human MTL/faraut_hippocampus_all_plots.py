...
faraut_hc_pars,cov = curve_fit(func,x_m,faraut_hc_mean,p0=[1,100,1],bounds=((0,np.inf)))

plt.plot(x_m,faraut_hc_mean,label='original data')
plt.plot(x_m,func(x_m,*faraut_hc_pars),label='fit curve')
