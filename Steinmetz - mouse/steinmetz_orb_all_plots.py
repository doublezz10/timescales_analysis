...
orb = spio.loadmat('/Users/zachz/Dropbox/Timescales across species/By trial/Steinmetz - mouse/orb_iti_trial.mat',simplify_cells=True)

#%% Extract spiking data from one brain area

spikes = orb['orb_iti_by_trial']
...
plt.text(710,0.053,'tau = %i' %steinmetz_orb_pars[1])
plt.show()
