...
ila = spio.loadmat('/Users/zachz/Dropbox/Timescales across species/By trial/Steinmetz - mouse/ila_iti_trial.mat',simplify_cells=True)

#%% Extract spiking data from one brain area

spikes = ila['ila_iti_by_trial']
