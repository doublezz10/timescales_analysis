...
bla = spio.loadmat('/Users/zachz/Dropbox/Timescales across species/Spiketimes only/Buzsaki2/whole_session/buzsaki_bla.mat',simplify_cells=True)
...
plt.xscale('log')
plt.title('%i Rat amygdala units \n Buzsaki, whole session' %len(buzsaki_amy_taus))
plt.show()
