...
fake_data = pd.read_csv('/Users/zachz/Documents/timescales_analysis/Buzsaki/buzsaki_bla_awake_results.csv')

#%%

filtered_fake = fake_data[(fake_data.tau >= 10) & (fake_data.tau <= 1000)]

filt_units = filtered_fake.unit.unique()
...
for unit in range(len(filt_units)):
    
    this_id = filt_units[unit]
