...
for unit in range(len(spikes)):
    ...
    if np.isnan(one_autocorrelation).any() == True:
        ...
        all_data_buzsaki_mpfc.append(('buzsaki','rat','mpfc',unit+1,pars[1],np.sum(summed_spikes_per_bin)/trials,r2,pars[0],pars[2]))

with open('/Users/zachz/Documents/timescales_analysis/results.csv','a') as out:
    csv_out=csv.writer(out)
    for row in all_data_buzsaki_mpfc:
...
a_population_buzsaki_mpfc = (('buzsaki','mpfc',buzsaki_mpfc_pars[1],buzsaki_mpfc_mean_fr,len(buzsaki_mpfc_taus)))
