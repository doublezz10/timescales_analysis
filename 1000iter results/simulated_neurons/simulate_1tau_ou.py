...
for tau in [60,120,180,240,300]: 
    ...
    for subplot in range(1,5):
        ...
        ax.hist(iter_taus,alpha=0.6)

        ax.axvline(np.mean(iter_taus),label="mean of 1000iter",color='red',linestyle='--',alpha=0.7)
        ax.axvline(one_fit_tau,label="one fit",color='green',linestyle='--',alpha=0.7)
        ax.axvline(tau,label='true tau',color='yellow',linestyle='--',alpha=0.7)
