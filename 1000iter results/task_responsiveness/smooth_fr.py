...
amyg_mat = spio.loadmat('/Users/zachz/Dropbox/Timescales across species/Spiketimes only/Steinmetz - mouse/stein_bla.mat',simplify_cells=True)

hc_mat = spio.loadmat('/Users/zachz/Dropbox/Timescales across species/Spiketimes only/Steinmetz - mouse/stein_ca1.mat',simplify_cells=True)
...
for unit in range(10):
    ...
    plt.title('Steinmetz BLA unit %i' %unit)
