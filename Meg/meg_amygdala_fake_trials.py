...
amy = spio.loadmat('/Users/zachz/Dropbox/Timescales across species/Spiketimes only/Meg - monkey/meg_amygdala.mat',simplify_cells=True)
...
for unit in range(len(spikes)):
    ...
    if np.isnan(one_autocorrelation).any() == True:
        ...
        all_data_meg_amyg_faketrials.append(('meg','monkey','amyg',unit,pars[1],np.sum(summed_spikes_per_bin)/trials,r2,pars[0],pars[2]))
